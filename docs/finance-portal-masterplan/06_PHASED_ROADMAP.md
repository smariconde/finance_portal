...
| Fase 1 - Vertical slice personal | in_progress | `F1-07` cerrado el 2026-08-26 con el gate E2E/accesibilidad y la frontera de modo movida al request (ADR 0005 y 0006); sigue `F1-08` |
