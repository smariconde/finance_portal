...
| Fase 1 - Vertical slice personal | in_progress | `F1-06` cerrado el 2026-08-25 con `/valuacion/referencia` y el pivote personal-first de la ADR 0004; sigue `F1-07` |
...
**Bloqueos actuales:** ninguno. La revision renderizada de `F1-06` la ejecuto el owner a mano; automatizarla es criterio de `F1-07`.
...
- [ ] Unit, contract y un E2E del flujo personal y del runtime trabado.
