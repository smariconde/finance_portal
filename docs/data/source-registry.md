...
| ------------------------- | ------------------------------------------------------- | ---- | -------------------- | ----------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `sec-edgar`               | identidad CIK, submissions, filings y XBRL/companyfacts | 2    | `integrated`         | `approved_personal`     | Universo y companyfacts integrados detrás del gate de derechos y del egress; User-Agent con contacto real y 2 req/s ([ADR 0010](../architecture/adr/0010-sec-xbrl-ingestion.md)) |
