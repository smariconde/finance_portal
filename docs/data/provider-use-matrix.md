...
| -------------------------- | ---------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| `sec-edgar`                | máximo Fair Access: 10 requests/s agregadas                                        | 2 requests/s, concurrencia 1 y 1.000 requests/run —implementados en `F2-03`—; hasta 64 archivos históricos de submissions por empresa | bulk para backfill; submissions detecta cambios; company facts sólo para CIK cambiados | pausar, persistir cursor y reanudar con backoff; nunca rotar IP          |
