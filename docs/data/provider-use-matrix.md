...
Por eso `F7-01` queda a la espera de una decisión de fuente del owner y la Fase 7
arranca por `F7-02`, que no necesita precios. La decisión pendiente es de tres
caminos: pagar un plan que permita persistir, asumir por escrito una fuente sin
concesión contractual, o relevar las opciones pagas baratas antes de elegir.
