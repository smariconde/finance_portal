...
| -------------------------- | ---------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------- |
| `sec-edgar`                | máximo Fair Access: 10 requests/s agregadas                                        | 2 requests/s, concurrencia 1 y 1.000 requests/run —implementados en `F2-03`—; hasta 64 archivos históricos de submissions por empresa | backfill por empresa como job durable con lease por fuente y reserva de 66 requests por empresa (ADR 0015); submissions detecta cambios; company facts sólo para CIK cambiados | pausar el job con `not_before`, persistir cursor y reanudar con backoff —implementado en `F2-05`—; nunca rotar IP |
